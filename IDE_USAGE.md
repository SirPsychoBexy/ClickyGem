...
*Open the project:*<br>
Run Code::Blocks, and open the project in `ClickyGem/build/codeblocks`.<br>
Finally, build and run the project.
...
cd ClickyGem
mkdir ../eclipse-ClickyGem
cd ../eclipse-ClickyGem

# Generate an Eclipse project
cmake ../ClickyGem -G "Eclipse CDT4 - Unix Makefiles"
```
*Open the project:*<br>
Run Eclipse, and open the project in `eclipse-ClickyGem`.<br>
